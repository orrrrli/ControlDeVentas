...
<template>
  <v-app id="inspire">
    ...
    <v-navigation-drawer :clipped="$vuetify.breakpoint.lgAndUp" v-model="drawer"  permanent app >
      <template>
...
<v-footer>
    <v-card height="30" width="100%" class="text-center white--text" color="blue
    darken-4">
      <h3> ISyTE - FIAD-UABC - {{ new Date().getFullYear() }} </h3>
    </v-card>
</v-footer>
  </v-app>
</template>
